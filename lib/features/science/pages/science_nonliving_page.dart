...
class ScienceNonLivingPage extends StatefulWidget {
  final AdService adService;
  const ScienceNonLivingPage({super.key, required this.adService});

  @override
  State<ScienceNonLivingPage> createState() => _ScienceNonLivingPageState();
}
...
class _ScienceNonLivingPageState extends State<ScienceNonLivingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = ContentType.scienceNonLivingHub.gradient;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Icon(ContentType.scienceNonLivingHub.icon, size: 24),
            const SizedBox(width: 8),
            Flexible(
              child: Text(
                ContentType.scienceNonLivingHub.localizedTitle(loc),
