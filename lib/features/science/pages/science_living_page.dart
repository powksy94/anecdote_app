...
class ScienceLivingPage extends StatefulWidget {
  final AdService adService;
  const ScienceLivingPage({super.key, required this.adService});

  @override
  State<ScienceLivingPage> createState() => _ScienceLivingPageState();
}

class _ScienceLivingPageState extends State<ScienceLivingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final loc = AppLocalizations.of(context)!;
    final gradient = ContentType.scienceLivingHub.gradient;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Icon(ContentType.scienceLivingHub.icon, size: 24),
            const SizedBox(width: 8),
            Flexible(
              child: Text(
                ContentType.scienceLivingHub.localizedTitle(loc),
