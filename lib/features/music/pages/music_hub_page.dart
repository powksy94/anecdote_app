...
class MusicHubPage extends StatefulWidget {
  ...
  const MusicHubPage({super.key, required this.adService});
...
class _MusicHubPageState extends State<MusicHubPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = ContentType.musicHub.gradient;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Icon(ContentType.musicHub.icon, size: 24),
            const SizedBox(width: 8),
            Flexible(
              child: Text(
                ContentType.musicHub.localizedTitle(loc),
