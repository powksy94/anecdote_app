import '../data/mental_medication_data.dart';
import '../../../core/models/content_data.dart';

class MentalMedicationService {
  static List<MentalMedicationData>? _cache;

  Future<ContentData> getDailyContent() async {
    _cache ??= await loadMentalMedications();
    final m = dailyMentalMedication(_cache!);
