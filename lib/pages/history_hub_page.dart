...
class HistoryHubPage extends StatefulWidget {
  ...
  const HistoryHubPage({super.key, required this.adService});
...
class _HistoryHubPageState extends State<HistoryHubPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = ContentType.historyHub.gradient;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Icon(ContentType.historyHub.icon, size: 24),
            const SizedBox(width: 8),
            Flexible(
              child: Text(
                ContentType.historyHub.localizedTitle(loc),
